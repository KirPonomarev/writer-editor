...
## ALLOWLIST
- test/contracts/rtk-export01-unified-bookmark.contract.test.js
...
SCOPE_EXTENSION_2: Preserve the complete emitted bookmark set in the existing EXPORT01-E2 positive resolver fixture. Its old single-paragraph package omitted the other declared scene and cannot qualify as complete identity continuity. Exact routing assertions stay unchanged; loss remains rejected. Evidence locator copies use lossless bounded gzip with raw-byte hashes; ZIP/XML and inventory limits stay unchanged.
