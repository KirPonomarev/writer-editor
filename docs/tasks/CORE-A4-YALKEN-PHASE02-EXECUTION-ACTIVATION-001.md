...
CHECK_04_PRE_CAPTURE_HEAD_BASELINE_AND_TRACKED_TASK_EXISTS
CMD: git rev-parse HEAD > /tmp/CORE-A4-YALKEN-PHASE02-EXECUTION-ACTIVATION-001.head && git ls-files --error-unmatch docs/tasks/CORE-A4-YALKEN-PHASE02-EXECUTION-ACTIVATION-001.md > /dev/null && echo OK
PASS: OUT == OK
