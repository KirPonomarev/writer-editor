...
- width-scale stays independent; the main shell uses layout zoom instead of transform-scale, while the editor sheet and left system toolbar remain outside this scale channel
