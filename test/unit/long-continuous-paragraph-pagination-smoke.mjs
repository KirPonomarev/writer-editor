...
assert.equal(result.afterScroll.laterThanThirdSheetTextRectCount > 0, true);
...
const summary = {
  ...
  totalPageCount: result.fixture.totalPageCount,
  markerSheetIndex: result.afterScroll.markerSheetIndex,
  page3TextRectCount: result.afterScroll.page3TextRectCount,
  laterThanThirdSheetTextRectCount: result.afterScroll.laterThanThirdSheetTextRectCount,
  visibleTextGapIntersectionCount: result.afterScroll.visibleTextGapIntersectionCount,
  visibleTextOutsideVisibleSheetRectCount: result.afterScroll.visibleTextOutsideVisibleSheetRectCount,
  proseMirrorCount: result.afterScroll.proseMirrorCount,
  derivedSheetEditableSurfaceCount: result.afterScroll.derivedSheetEditableSurfaceCount,
  derivedSheetProseMirrorCount: result.afterScroll.derivedSheetProseMirrorCount,
  derivedSheetEditorCount: result.afterScroll.derivedSheetEditorCount,
  screenshots: result.screenshots.map((filePath) => path.basename(filePath)),
};
