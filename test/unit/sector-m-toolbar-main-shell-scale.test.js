...
test('sector-m toolbar main shell scale: css uses layout zoom and keeps width scale separate', () => {
  ...
  assert.ok(shellSection.includes('zoom: var(--floating-toolbar-scale);'));
