    ...
    if (
      ...
      && (
        ...
        || (
          ...
          && Number(state.centralSheetBoundedOverflowSourcePageCount) > 5
          && state.centralSheetBoundedOverflowVisiblePageCount === '5'
...
assert.equal(result.fixture.verticallyStackedSheetPairCount, 4);
