...
const ALLOWLIST = [
  ...
  'src/export/markdown/v1/documentIr.mjs',
  ...
  'docs/OPS/STATUS/REVIEW_BRIDGE_MARKDOWN_PRODUCT_COMPLETION_001_STATUS.json',
  ...
  'test/unit/sector-m-review-surface-ui.test.js',
  ...
  'test/unit/markdown-import-product-parity-ui-flow.test.js',
  'test/unit/sector-m-import-export-entry-truth.test.js',
  CONTRACT_PATH,
];
