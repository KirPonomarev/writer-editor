...
for(const era of ['C1','REVIEW','HOSTILE','MEDIA','REOPEN','TABLE_FILES','IMPORT_TRANSACTION','IMPORT_LOSS'])test(era+' Word reader successor admits one complete set and rejects mixed or altered bindings', async () => {
  ...
  if (!['REOPEN','TABLE_FILES','IMPORT_TRANSACTION','IMPORT_LOSS'].includes(era)) {
