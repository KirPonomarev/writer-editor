...
for(const era of ['C1','REVIEW','HOSTILE','MEDIA','REOPEN','TABLE_FILES','IMPORT_TRANSACTION','IMPORT_LOSS','MEDIA_DISPLAY','MEDIA_TEXT','TABLE_PROPERTIES','COMPOSITE_FIDELITY','CURRENT_STRUCTURE','MACOS27','IMPORT_CONTRACT','PROOF_SUCCESSOR','READER_PIN','INLINE_ATOMS','VISIBILITY_RUBY','HTTP_LINKS','ROUND_KEY_DURABILITY','CLEAN_LINK_LABEL','STRUCTURAL_TRANSACTION','AUTHORED_TOPOLOGY'])test(era+' Word reader successor admits one complete set and rejects mixed or altered bindings', async () => {
  ...
  if (!['REOPEN','TABLE_FILES','IMPORT_TRANSACTION','IMPORT_LOSS','MEDIA_DISPLAY','MEDIA_TEXT','TABLE_PROPERTIES','COMPOSITE_FIDELITY','CURRENT_STRUCTURE','MACOS27','IMPORT_CONTRACT','PROOF_SUCCESSOR','READER_PIN','INLINE_ATOMS','VISIBILITY_RUBY','HTTP_LINKS','ROUND_KEY_DURABILITY','CLEAN_LINK_LABEL','STRUCTURAL_TRANSACTION','AUTHORED_TOPOLOGY'].includes(era)) {
