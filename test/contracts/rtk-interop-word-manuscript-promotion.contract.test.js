...
for(const era of ['C1','REVIEW','HOSTILE','MEDIA','REOPEN','TABLE_FILES','IMPORT_TRANSACTION','IMPORT_LOSS','MEDIA_DISPLAY','MEDIA_TEXT','TABLE_PROPERTIES','COMPOSITE_FIDELITY','CURRENT_STRUCTURE','MACOS27'])test(era+' Word reader successor admits one complete set and rejects mixed or altered bindings', async () => {
  ...
  const git = args => {
    if (args[0] === 'rev-parse') {
      for (const set of [cert.R24_INTEROP_WORD_PROMOTION_SUCCESSOR,cert.R24_INTEROP_WORD_TABLES_C1_SUCCESSOR,cert.R24_INTEROP_WORD_TABLES_REVIEW_SUCCESSOR,cert.R24_INTEROP_WORD_HOSTILE_SUCCESSOR,cert.R24_INTEROP_WORD_MEDIA_SUCCESSOR,cert.R24_INTEROP_WORD_NATIVE_REOPEN_SUCCESSOR,cert.R24_INTEROP_WORD_TABLE_FILES_SUCCESSOR,cert.R24_INTEROP_WORD_IMPORT_TRANSACTION_SUCCESSOR,cert.R24_INTEROP_WORD_IMPORT_LOSS_SUCCESSOR,cert.R24_INTEROP_WORD_MEDIA_DISPLAY_SUCCESSOR,cert.R24_INTEROP_WORD_MEDIA_TEXT_SUCCESSOR,cert.R24_INTEROP_WORD_TABLE_PROPERTIES_SUCCESSOR,cert.R24_INTEROP_WORD_COMPOSITE_FIDELITY_SUCCESSOR,cert.R24_INTEROP_WORD_CURRENT_STRUCTURE_SUCCESSOR,cert.R24_INTEROP_WORD_MACOS27_SUCCESSOR]) {
  ...
  if (!['REOPEN','TABLE_FILES','IMPORT_TRANSACTION','IMPORT_LOSS','MEDIA_DISPLAY','MEDIA_TEXT','TABLE_PROPERTIES','COMPOSITE_FIDELITY','CURRENT_STRUCTURE','MACOS27'].includes(era)) {
