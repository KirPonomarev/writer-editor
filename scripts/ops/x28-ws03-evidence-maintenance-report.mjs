...
import { evaluateX28Ws03EvidenceMaintenanceState } from './x28-ws03-evidence-maintenance-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X28_CONTOUR/TICKET_03';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X28_WS03_EVIDENCE_MAINTENANCE_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X28_WS03_EVIDENCE_MAINTENANCE_001';
...
function main() {
  ...
  const run1 = evaluateX28Ws03EvidenceMaintenanceState({ repoRoot });
  const run2 = evaluateX28Ws03EvidenceMaintenanceState({ repoRoot });
  const run3 = evaluateX28Ws03EvidenceMaintenanceState({ repoRoot });
