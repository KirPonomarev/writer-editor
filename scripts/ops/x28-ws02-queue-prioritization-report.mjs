...
import { evaluateX28Ws02QueuePrioritizationState } from './x28-ws02-queue-prioritization-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X28_CONTOUR/TICKET_02';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X28_WS02_QUEUE_PRIORITIZATION_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X28_WS02_QUEUE_PRIORITIZATION_001';
...
function main() {
  ...
  const run1 = evaluateX28Ws02QueuePrioritizationState({ repoRoot });
  const run2 = evaluateX28Ws02QueuePrioritizationState({ repoRoot });
  const run3 = evaluateX28Ws02QueuePrioritizationState({ repoRoot });
