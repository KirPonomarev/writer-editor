...
const TOKEN_NAME = 'X52_WS99_SYMBOLIC_CLOSEOUT_AND_SIGNED_PACKET_OK';
const EXPECTED_CANON_VERSION = 'v3.13a-final';

const FREEZE_PACKET_REL = 'docs/OPS/EVIDENCE/X52_CONTOUR/x52-contour-freeze-packet-v1.json';
const CLOSE_SUMMARY_REL = 'docs/OPS/STATUS/X52_CONTOUR_CLOSE_SUMMARY_V1.json';
const SIGNED_STATUS_REL = 'docs/OPS/STATUS/X52_CONTOUR_CLOSEOUT_SIGNED_V1.json';
const NEXT_RECORD_REL = 'docs/OPS/STATUS/NEXT_CONTOUR_OPENING_RECORD_V38.json';
const WS99_STATUS_REL = 'docs/OPS/STATUS/X52_WS99_SYMBOLIC_CLOSEOUT_AND_SIGNED_PACKET_STATUS_V1.json';

const PACKET_FILE_ALLOWLIST = new Set([
  'docs/OPS/EVIDENCE/X52_CONTOUR/',
  'docs/OPS/EVIDENCE/X52_CONTOUR/x52-contour-freeze-packet-v1.json',
  'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_99/',
  'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_99/negative-results.json',
  'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_99/positive-results.json',
  'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_99/final-dod-acceptance-summary.json',
  'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_99/closeout-summary.json',
  'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_99/signed-status.json',
  'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_99/freeze-packet-sha256.json',
  'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_99/repeatability-summary.json',
  'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_99/ticket-meta.json',
  'docs/OPS/STATUS/X52_CONTOUR_CLOSE_SUMMARY_V1.json',
  'docs/OPS/STATUS/X52_CONTOUR_CLOSEOUT_SIGNED_V1.json',
  'docs/OPS/STATUS/NEXT_CONTOUR_OPENING_RECORD_V38.json',
  'docs/OPS/STATUS/X52_WS99_SYMBOLIC_CLOSEOUT_AND_SIGNED_PACKET_STATUS_V1.json',
  'scripts/ops/x52-ws99-symbolic-closeout-and-signed-packet-state.mjs',
  'scripts/ops/x52-ws99-symbolic-closeout-and-signed-packet-report.mjs',
  'test/contracts/x52-ws99-symbolic-closeout-and-signed-packet.contract.test.js',
]);
...
const WS_REQUIREMENTS = [
  {
    id: 'WS01',
    ticketId: 'X52_WS01',
    statusRef: 'docs/OPS/STATUS/X52_WS01_NEXT_CONTOUR_ALIGNMENT_STATUS_V1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_01/summary.json',
  },
  {
    id: 'WS02',
    ticketId: 'X52_WS02',
    statusRef: 'docs/OPS/STATUS/X52_WS02_QUEUE_PRIORITIZATION_STATUS_V1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_02/summary.json',
  },
  {
    id: 'WS03',
    ticketId: 'X52_WS03',
    statusRef: 'docs/OPS/STATUS/X52_WS03_EVIDENCE_MAINTENANCE_STATUS_V1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_03/summary.json',
  },
  {
    id: 'WS04',
    ticketId: 'X52_WS04',
    statusRef: 'docs/OPS/STATUS/X52_WS04_CONTROLLED_DELIVERY_EXPANSION_STATUS_V1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_04/summary.json',
  },
];
...
function evaluateContourSignals(repoRoot) {
  const ws04Summary = readJsonObject(path.join(repoRoot, 'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_04/summary.json'));
...
function buildFreezePacketTemplate(input) {
  ...
  return {
    artifactId: 'X52_CONTOUR_EVIDENCE_FREEZE_PACKET_V1',
    schemaVersion: 1,
    ...
    contour: {
      ...
      gateDecision: 'X52_CLOSED_GO_NEXT',
    ...
    requiredOutputs: [
      'X52_CONTOUR_FREEZE_PACKET_V1_JSON',
      'X52_CONTOUR_CLOSE_SUMMARY_V1_JSON',
      'X52_CONTOUR_CLOSEOUT_SIGNED_V1_JSON',
      'NEXT_CONTOUR_OPENING_RECORD_V38_JSON',
...
function buildSignedStatusTemplate(freezePacketSha256) {
  return {
    artifactId: 'X52_CONTOUR_CLOSEOUT_SIGNED_V1',
    schemaVersion: 1,
    taskId: 'TZ_X52_WS99_SYMBOLIC_CLOSEOUT_AND_SIGNED_PACKET_001',
    status: 'SIGNED',
...
function buildCloseSummaryTemplate(freezePacketSha256, trustPass) {
  return {
    artifactId: 'X52_CONTOUR_CLOSE_SUMMARY_V1',
    schemaVersion: 1,
    taskId: 'TZ_X52_WS99_SYMBOLIC_CLOSEOUT_AND_SIGNED_PACKET_001',
...
function buildNextContourOpeningRecordTemplate() {
  return {
    ...
    owner: 'CODEX',
    ticketId: 'TZ_X52_NEXT_CONTOUR_OPENING_001',
    status: 'READY',
    priority: 'P1',
    ...
    executionGate: 'GO',
    dependsOn: {
      x52CloseoutArtifactRef: SIGNED_STATUS_REL,
      gateSatisfied: true,
      requiredGate: 'GO_IF_X52_CLOSEOUT_ARTIFACT_SIGNED',
    },
    entryChecks: {
...
export function evaluateX52Ws99SymbolicCloseoutAndSignedPacketState(input = {}) {
...
function main() {
  ...
  const state = evaluateX52Ws99SymbolicCloseoutAndSignedPacketState({ repoRoot: process.cwd() });

  if (args.json) {
    process.stdout.write(`${stableStringify(state)}\n`);
  } else {
    process.stdout.write(`X52_WS99_SYMBOLIC_CLOSEOUT_AND_SIGNED_PACKET_OK=${state.X52_WS99_SYMBOLIC_CLOSEOUT_AND_SIGNED_PACKET_OK}\n`);
