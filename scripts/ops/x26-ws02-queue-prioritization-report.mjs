...
import { evaluateX26Ws02QueuePrioritizationState } from './x26-ws02-queue-prioritization-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X26_CONTOUR/TICKET_02';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X26_WS02_QUEUE_PRIORITIZATION_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X26_WS02_QUEUE_PRIORITIZATION_001';
...
function main() {
  ...
  const run1 = evaluateX26Ws02QueuePrioritizationState({ repoRoot });
  const run2 = evaluateX26Ws02QueuePrioritizationState({ repoRoot });
  const run3 = evaluateX26Ws02QueuePrioritizationState({ repoRoot });
  ...
  const summary = {
    ...
    objective: 'PRIORITIZE_QUEUE_WITH_CANON_LOCK_AND_CONTROLLED_DELIVERY_EXPANSION',
