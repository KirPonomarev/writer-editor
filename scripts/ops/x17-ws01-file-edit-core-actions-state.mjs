...
const TOKEN_NAME = 'X17_WS01_FILE_EDIT_CORE_ACTIONS_OK';
...
const DEFAULT_FILE_EDIT_ACTIONS_PATH = 'docs/OPS/STATUS/X17_FILE_EDIT_CORE_ACTIONS_v1.json';
...
const EXPECTED_ACTION_IDS = Object.freeze(['new', 'open', 'save', 'save-as', 'undo', 'redo', 'find', 'replace']);
...
const REQUIRED_EDITOR_MARKERS = Object.freeze([
  'dispatchUiCommand(EXTRA_COMMAND_IDS.PROJECT_NEW)',
  'dispatchUiCommand(COMMAND_IDS.PROJECT_OPEN)',
  'dispatchUiCommand(COMMAND_IDS.PROJECT_SAVE)',
  'dispatchUiCommand(EXTRA_COMMAND_IDS.PROJECT_SAVE_AS)',
  'dispatchUiCommand(EXTRA_COMMAND_IDS.EDIT_UNDO)',
  'dispatchUiCommand(EXTRA_COMMAND_IDS.EDIT_REDO)',
  'dispatchUiCommand(EXTRA_COMMAND_IDS.EDIT_FIND)',
  'dispatchUiCommand(EXTRA_COMMAND_IDS.EDIT_REPLACE)',
]);
...
function evaluateX17Ws01FileEditCoreActionsState(input = {}) {
  ...
  negative02Binding.delete('cmd.project.edit.replace');
  ...
  const fileEditActionsEnabledWithoutCoreLeak = baseline.ok
    && determinism.ok
  ...
  const dod = {
    NEXT_TZ_DOD_01: fileEditActionsEnabledWithoutCoreLeak,
  ...
  const state = {
    ...
    objective: 'FILE_EDIT_CORE_ACTIONS_ENABLED_WITH_COMMAND_BUS_AND_CAPABILITY_POLICY',
    ...
    detector: {
      detectorId: 'X17_WS01_FILE_EDIT_CORE_ACTIONS_SINGLE_DETECTOR_V1',
          ...
          : !dod.NEXT_TZ_DOD_02
            ...
            : !dod.NEXT_TZ_DOD_03
              ...
              : !dod.NEXT_TZ_DOD_06
                ...
                : 'X17_WS01_FILE_EDIT_CORE_ACTIONS_FAIL';
...
function main() {
  ...
  const state = evaluateX17Ws01FileEditCoreActionsState({
...
export {
  evaluateX17Ws01FileEditCoreActionsState,
  TOKEN_NAME,
};
