...
import { evaluateX52Ws02QueuePrioritizationState } from './x52-ws02-queue-prioritization-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_02';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X52_WS02_QUEUE_PRIORITIZATION_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X52_WS02_QUEUE_PRIORITIZATION_001';
...
function main() {
  ...
  const run1 = evaluateX52Ws02QueuePrioritizationState({ repoRoot });
  const run2 = evaluateX52Ws02QueuePrioritizationState({ repoRoot });
  const run3 = evaluateX52Ws02QueuePrioritizationState({ repoRoot });
