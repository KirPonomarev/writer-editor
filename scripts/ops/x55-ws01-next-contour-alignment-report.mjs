...
import { evaluateX55Ws01NextContourAlignmentState } from './x55-ws01-next-contour-alignment-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X55_CONTOUR/TICKET_01';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X55_WS01_NEXT_CONTOUR_ALIGNMENT_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X55_WS01_NEXT_CONTOUR_ALIGNMENT_001';
...
function main() {
  ...
  const run1 = evaluateX55Ws01NextContourAlignmentState({ repoRoot });
  const run2 = evaluateX55Ws01NextContourAlignmentState({ repoRoot });
  const run3 = evaluateX55Ws01NextContourAlignmentState({ repoRoot });
