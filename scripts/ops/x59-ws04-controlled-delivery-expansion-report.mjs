...
import { evaluateX59Ws04ControlledDeliveryExpansionState } from './x59-ws04-controlled-delivery-expansion-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X59_CONTOUR/TICKET_04';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X59_WS04_CONTROLLED_DELIVERY_EXPANSION_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X59_WS04_CONTROLLED_DELIVERY_EXPANSION_001';
...
function main() {
  ...
  const run1 = evaluateX59Ws04ControlledDeliveryExpansionState({ repoRoot });
  const run2 = evaluateX59Ws04ControlledDeliveryExpansionState({ repoRoot });
  const run3 = evaluateX59Ws04ControlledDeliveryExpansionState({ repoRoot });
