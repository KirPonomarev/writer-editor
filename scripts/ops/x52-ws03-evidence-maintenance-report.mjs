...
import { evaluateX52Ws03EvidenceMaintenanceState } from './x52-ws03-evidence-maintenance-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X52_CONTOUR/TICKET_03';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X52_WS03_EVIDENCE_MAINTENANCE_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X52_WS03_EVIDENCE_MAINTENANCE_001';
...
function main() {
  ...
  const run1 = evaluateX52Ws03EvidenceMaintenanceState({ repoRoot });
  const run2 = evaluateX52Ws03EvidenceMaintenanceState({ repoRoot });
  const run3 = evaluateX52Ws03EvidenceMaintenanceState({ repoRoot });
