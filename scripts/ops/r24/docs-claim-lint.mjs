...
import { canonicalize, readJsonBounded, sha256hex } from './canonical-json.mjs';
...
// U+000C successor work refreshes the current inventory again; the repaired
// RCV00D selector evidence remains exact historical bytes at its delivery.
export const HISTORICAL_INVENTORY_CLAIM_PINS_V32 = Object.freeze([
  Object.freeze({ stampId: 'ES-R24-RCV00D-GRAPH-DERIVED-SELECTOR-CLAIM-BINDINGS', stampSha256: 'eb71b349011483d0ec5fba1f0032f9a1d74413cbe2371f22ee7309829d98eb8e',
...
// Comment-topology successor work refreshes the current inventory again; the
// RCV00E lease-fencing CAS stamp remains exact historical bytes at delivery.
export const HISTORICAL_INVENTORY_CLAIM_PINS_V34 = Object.freeze([
  Object.freeze({ stampId: 'ES-R24-RCV00E-LEASE-FENCING-CAS-CLAIM-BINDINGS', stampSha256: '8cb59e5ae4d63bdfea0d33e6d853c78dd213cc83d7eb4640cf746eba295a25b7',
    evaluationSha: 'c36344ab3b5905759e699aec81c93efd5b71827c', evaluationTree: 'ba75350518e0cb61210c992247bca5fe5e06b43c', targetSha256: '68fb6546cbfecd00a97a40c275431d68bca6f7adb79cd072e751aef9797f4768' }),
  ...HISTORICAL_INVENTORY_CLAIM_PINS_V33,
]);
// P07 successor work refreshes the current inventory again; PR1882 PRE00F
// current-head reconciliation remains exact historical evidence at delivery.
export const HISTORICAL_INVENTORY_CLAIM_PINS_V35 = Object.freeze([
  Object.freeze({ stampId: 'ES-R24-PRE00F-CURRENT-HEAD-PLAN-DELIVERY-RECONCILIATION', stampSha256: '904281313aec77f5f4ca82e183c15aaa595af0278ba98e317b15760ccaa93a8f',
    evaluationSha: '18bff1711dde771d1c5e8548cef1b4735085ccdd', evaluationTree: 'e195f6c2e88251f845325b1706639d5fb80f88d8', targetSha256: 'f567f51050f98731966e2080ed3ac08b4dbe528b4f905cd49c5cf74ca353a850' }),
  ...HISTORICAL_INVENTORY_CLAIM_PINS_V34,
]);
// This RCV00D successor branch merged P07 current-main evidence, refreshing the
// live inventory while preserving earlier current-claim carriers as immutable
// historical bytes.
export const HISTORICAL_INVENTORY_CLAIM_PINS_V36 = Object.freeze([
  Object.freeze({ stampId: 'ES-R24-INTEROP-100-C1B-CURRENT-CLAIM-BINDINGS', stampSha256: '7ac9dcc891ce5c91ad6b8c3f4a7997bdb315ae5db45aea67fcf53f85f2dcbaa0',
    evaluationSha: 'ae8838dc3cca5f3bbcc420936baf589b2d3be3fa', evaluationTree: '3cfbb8d48e301dc56b2390d7be1499a4eb8414c4', targetSha256: '95c0434ddd680dc3a9580a7377d1b13432ef7497ee49bdc6ac6bade314efb138' }),
  Object.freeze({ stampId: 'ES-R24-RCV00A-EXACT-TOOLCHAIN-ENTRYPOINT-CLAIM-BINDINGS', stampSha256: '7c00deaa5d56d5b5189570c323fb7ee748ca33cb0a16e26795d2e3707fad0344',
    evaluationSha: 'ae8838dc3cca5f3bbcc420936baf589b2d3be3fa', evaluationTree: '3cfbb8d48e301dc56b2390d7be1499a4eb8414c4', targetSha256: '95c0434ddd680dc3a9580a7377d1b13432ef7497ee49bdc6ac6bade314efb138' }),
  Object.freeze({ stampId: 'ES-R24-RCV00D-GRAPH-DERIVED-SELECTOR-CLAIM-BINDINGS', stampSha256: '6c6dc7bd0fdab3a7163f327fd33a2c30954ea58a402a8c65c73c3049da056b5e',
    evaluationSha: '9c85e70b3166f2a78e61d5aba454820afa303e80', evaluationTree: 'f3709b7a15ed7309c6043ed3f4736c8673375027', targetSha256: '3fb2cd80af4a1c7e2fab999311db7736c3b0420a26a31490e03f52cad5248d5e' }),
  ...HISTORICAL_INVENTORY_CLAIM_PINS_V35,
]);
// Current-head exact-toolchain evidence refreshes the live C1B inventory. The
// PRE00F current-head and RCV01A manifest carriers from the exact RCV00A base
// remain immutable historical bytes.
export const HISTORICAL_INVENTORY_CLAIM_PINS_V37 = Object.freeze([
  Object.freeze({ stampId: 'ES-R24-PRE00F-CURRENT-HEAD-PLAN-DELIVERY-RECONCILIATION', stampSha256: 'aa326767ecdd3d9097cbaf372904f62e28b0824eab8c3b0c189c35ce695bbbc3',
    evaluationSha: '389dbc5e39a5d541b64a8187921c24ca5bf43876', evaluationTree: '5e792c0867a35c1b2c85cffb3478fb4357bd159c', targetSha256: '0fae17c0476ca4672a28e10c6043233e12ba3599772ca89ed18cc1c666313ccd' }),
  Object.freeze({ stampId: 'ES-R24-RCV01A-NORMATIVE-CLAIM-TEST-LANE-MANIFEST-CLAIM-BINDINGS', stampSha256: '57d2bf5a2dabc4b2e8f55d05ff4f95029526f9fa6f409e76762d5827068948dc',
    evaluationSha: '389dbc5e39a5d541b64a8187921c24ca5bf43876', evaluationTree: '5e792c0867a35c1b2c85cffb3478fb4357bd159c', targetSha256: '0fae17c0476ca4672a28e10c6043233e12ba3599772ca89ed18cc1c666313ccd' }),
  ...HISTORICAL_INVENTORY_CLAIM_PINS_V36,
]);
// RCV00B current-head effective-state compiler evidence refreshes live C1B
// inventory; the RCV00A current-head exact-toolchain carrier stays historical.
export const HISTORICAL_INVENTORY_CLAIM_PINS_V38 = Object.freeze([
  Object.freeze({ stampId: 'ES-R24-RCV00A-CURRENT-HEAD-EXACT-TOOLCHAIN-ENTRYPOINT', stampSha256: '886b685479dfbd5276bd5f45109405019a2097aafebce715dbe1d6856808d5b0',
    evaluationSha: 'e9aa4e3f5b75ea574d72baec4ac7e4ae20ce5c36', evaluationTree: '31526ec5d5aebf883a65352ccf7525903d7cd2a9', targetSha256: 'b446e1d623feae8b4202476019b504818892eb08af411b4f053d693b9b5c5a9e' }),
  ...HISTORICAL_INVENTORY_CLAIM_PINS_V37,
]);
// PR1888 refreshes current C1B inventory bytes again; the RCV00B current-head
// effective-state compiler stamp remains exact evidence for its evaluation SHA.
export const HISTORICAL_INVENTORY_CLAIM_PINS_V39 = Object.freeze([
  Object.freeze({ stampId: 'ES-R24-RCV00B-CURRENT-HEAD-EFFECTIVE-STATE-COMPILER', stampSha256: '59e7c44a91735dbba6cda2bbba726d26ebc5691321858517a9a001a5ad78a4d9',
    evaluationSha: '9fc69f8980a4266ab43a0c4609802d9c6264f7aa', evaluationTree: '7ef4a55ac44bbe5e51c649f42305c35d07b3a306', targetSha256: 'c9c0ace2f022e949ead320162a8d900e8a9658e0313fdd636fcb27ab95da8498' }),
  ...HISTORICAL_INVENTORY_CLAIM_PINS_V38,
]);
// PR1892 repairs RCV00B loader parity and refreshes the same current-head
// evidence carrier before PR1888 merges forward.
export const HISTORICAL_INVENTORY_CLAIM_PINS_V40 = Object.freeze([
  Object.freeze({ stampId: 'ES-R24-RCV00B-CURRENT-HEAD-EFFECTIVE-STATE-COMPILER', stampSha256: 'a7f7beff4454cdcc026c8a907473fe76d57a40d6b1ca0cbf749cf8901cf46ace',
...
// O01-O08 source-runtime oracle hardening refreshes live C1B inventory; the
// interop-100 current-claim binding from the exact base remains historical.
export const HISTORICAL_INVENTORY_CLAIM_PINS_V42 = Object.freeze([
  Object.freeze({ stampId: 'ES-R24-INTEROP-100-C1B-CURRENT-CLAIM-BINDINGS', stampSha256: 'bc26e4f5907c1142e667f2385641116ba5079b442ae614ed5fe135be914106c6',
    evaluationSha: '071daa0fa544accd0d1f038175780036145372aa', evaluationTree: '244712adbbe7bfe745f5df38900b776b2ca9b0aa', targetSha256: '8ddbb2c40b70b74fa6251bd89d59967cd2014c3c5698d8ab6be3d812a93545ec' }),
  ...HISTORICAL_INVENTORY_CLAIM_PINS_V41,
]);
// Merge-gate dependency-set repair refreshes live C1B inventory; the RCV01A
// non-current worktree-candidate carrier from the exact repair base is now
// historical-only evidence.
export const HISTORICAL_INVENTORY_CLAIM_PINS_V43 = Object.freeze([
  Object.freeze({ stampId: 'ES-R24-RCV01A-NORMATIVE-CLAIM-TEST-LANE-MANIFEST-CLAIM-BINDINGS', stampSha256: 'fba98b6adb7dc866dc77f6e8134495d46d7b72ca926fbdeaf5fa997e4c927b64',
    evaluationSha: 'd5d7ed98095d1f396d7e0f8336ad19eb8c6fc05b', evaluationTree: 'a4008a86dee5ea098bf53b84003c8b42d34fc464', targetSha256: '56f3789e6d70721413811c0e9d76971133768eec6b57e5eb12f2f1f4ab4971a2' }),
...
export function verifyHistoricalInventoryClaim({ rootDir, stamp, stampBytes, binding, git = historicalGit }) {
  const pins = HISTORICAL_INVENTORY_CLAIM_PINS_V43.filter(item => item.stampId === stamp.stampId);
...
function rcv01aBoundFileSetDigest(entries) {
  return sha256hex(`${canonicalize(entries.map((entry) => ({
    path: entry.path,
...
function validateRcv01aImplementationBindings(rootDir, implementationArtifactDigests, fail) {
  const entries = [];
  for (const entry of implementationArtifactDigests) {
    if (!isObjectRecord(entry)) fail('E_RCV01A_WORKTREE_CANDIDATE_IMPLEMENTATION_ENTRY');
    if (!safeRepoRelative(entry.path)) fail('E_RCV01A_WORKTREE_CANDIDATE_IMPLEMENTATION_PATH');
    if (!HEX64_RE.test(String(entry.sha256 || ''))) fail('E_RCV01A_WORKTREE_CANDIDATE_IMPLEMENTATION_DIGEST');
    const fullPath = path.resolve(rootDir, entry.path);
    const rootPath = path.resolve(rootDir);
    if (!fullPath.startsWith(rootPath + path.sep)) {
      fail('E_RCV01A_WORKTREE_CANDIDATE_IMPLEMENTATION_OUTSIDE_ROOT');
    }
    let before;
    try {
      before = fs.lstatSync(fullPath, { bigint: true });
    } catch {
      fail('E_RCV01A_WORKTREE_CANDIDATE_IMPLEMENTATION_MISSING');
    }
    if (!before.isFile()) fail('E_RCV01A_WORKTREE_CANDIDATE_IMPLEMENTATION_NOT_FILE');
    let realPath;
    try {
      realPath = fs.realpathSync.native(fullPath);
    } catch {
      fail('E_RCV01A_WORKTREE_CANDIDATE_IMPLEMENTATION_REALPATH');
    }
    ...
    if (!sameFileIdentity(before, after)) fail('E_RCV01A_WORKTREE_CANDIDATE_IMPLEMENTATION_UNSTABLE');
    if (sha256hex(bytes) !== entry.sha256) {
      fail('E_RCV01A_WORKTREE_CANDIDATE_IMPLEMENTATION_DIGEST_MISMATCH');
    }
    entries.push({ section: 'implementationArtifactDigests', path: entry.path, sha256: entry.sha256 });
  }
  return entries;
}

function buildRcv01aWorktreeCandidateClaimBinding(artifact, { rootDir, file }) {
  ...
  if (path.basename(file) !== `${artifact.stampId}.json`) fail('E_RCV01A_WORKTREE_CANDIDATE_BASENAME');
  ...
  const claimEntries = artifact.claimBindings.map((entry) => {
    if (!isObjectRecord(entry)) fail('E_RCV01A_WORKTREE_CANDIDATE_CLAIM_ENTRY');
    if (!safeSurfaceRelative(entry.filePath)) fail('E_RCV01A_WORKTREE_CANDIDATE_CLAIM_PATH');
    if (!HEX64_RE.test(String(entry.sha256 || ''))) fail('E_RCV01A_WORKTREE_CANDIDATE_CLAIM_DIGEST');
    return { section: 'claimBindings', path: entry.filePath, sha256: entry.sha256 };
  });
  const implementationEntries = validateRcv01aImplementationBindings(rootDir, artifact.implementationArtifactDigests, fail);
  if (candidate.boundFileSetDigest !== rcv01aBoundFileSetDigest([...claimEntries, ...implementationEntries])) {
    fail('E_RCV01A_WORKTREE_CANDIDATE_FILE_SET_MISMATCH');
  }
...
function addBinding({ rootDir, evidenceDir, stamp, file, bindingsByFile, historicalBindings, failures }) {
  ...
  for (const binding of stamp.claimBindings) {
    ...
    if (actual !== binding.sha256 && relativePath === INVENTORY_PATH
      && HISTORICAL_INVENTORY_CLAIM_PINS_V43.some(pin => pin.stampId === stamp.stampId)) {
      try {
  ...
  for (const file of listFiles(evidenceDir)) {
    ...
    try {
      ...
      if (artifact?.schemaVersion === 'EvidenceStampV2') {
        ...
        const binding = buildRcv01aWorktreeCandidateClaimBinding(artifact, { rootDir, file });
        stampIds.add(binding.stampId);
        addBinding({ rootDir, evidenceDir, stamp: binding, file, bindingsByFile, historicalBindings, failures });
