...
const DEFAULT_FREEZE_PATH = 'docs/OPS/EVIDENCE/X21_CONTOUR/x21-contour-freeze-packet-v1.json';
const DEFAULT_CLOSE_SUMMARY_PATH = 'docs/OPS/STATUS/X21_CONTOUR_CLOSE_SUMMARY_V1.json';
const DEFAULT_SIGNED_PATH = 'docs/OPS/STATUS/X21_CONTOUR_CLOSEOUT_SIGNED_V1.json';
const DEFAULT_NEXT_RECORD_PATH = 'docs/OPS/STATUS/NEXT_CONTOUR_OPENING_RECORD_V8.json';
...
const WS_MAP = [
  {
    id: 'WS01',
    ticketId: 'X21_WS01',
    statusRef: 'docs/OPS/STATUS/X21_WS01_RELEASE_CANDIDATE_PRECHECK_PACK_v1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X21_CONTOUR/TICKET_01/summary.json',
  },
  {
    id: 'WS02',
    ticketId: 'X21_WS02',
    statusRef: 'docs/OPS/STATUS/X21_WS02_PROMOTION_DRY_RUN_AND_EVIDENCE_LOCK_v1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X21_CONTOUR/TICKET_02/summary.json',
  },
];
...
function parseArgs(argv = process.argv.slice(2)) {
  const out = {
    ...
    runId: 'TZ_X21_WS03_CONTOUR_CLOSE_PREP_001',
  };
...
function main() {
  ...
  const freezePacket = {
    artifactId: 'X21_CONTOUR_EVIDENCE_FREEZE_PACKET_V1',
    schemaVersion: 1,
    generatedAtUtc,
    owner: 'KIRILL_PLUS_CODEX',
    gate: {
      name: 'GO_IF_X21_WS01_AND_X21_WS02_ACCEPTED',
    ...
    requiredOutputs: [
      'X21_CONTOUR_FREEZE_PACKET_JSON',
      'X21_CONTOUR_CLOSE_SUMMARY_JSON',
      'X21_CONTOUR_CLOSEOUT_SIGNED_JSON',
  ...
  const signedDoc = {
    artifactId: 'X21_CONTOUR_CLOSEOUT_SIGNED_V1',
    schemaVersion: 1,
    taskId: args.runId,
    status: 'SIGNED',
    ...
    gate: {
      name: 'GO_IF_X21_CLOSEOUT_ARTIFACT_SIGNED',
      isOpen: true,
  ...
  const closeSummary = {
    artifactId: 'X21_CONTOUR_CLOSE_SUMMARY_V1',
    schemaVersion: 1,
    taskId: args.runId,
    ...
    closeout: {
      action01_freezeX21EvidencePacket: 'DONE',
      action02_recordX21ContourCloseSummary: 'DONE',
      action03_openNextContourRecord: 'DONE',
    },
    nextTicket: {
      tzId: 'TZ_X22_CONTOUR_OPENING_001',
      priority: 'P1',
      objective: 'OPEN_NEXT_CONTOUR_WITH_CANON_LOCK_AND_NON_EXPANDING_BLOCKING_SURFACE',
      gate: 'GO_IF_X21_CLOSEOUT_ARTIFACT_SIGNED',
    },
  };
  ...
  const nextRecord = {
    ticketId: 'TZ_X22_CONTOUR_OPENING_001',
    schemaVersion: 1,
    status: 'READY',
    priority: 'P1',
    mode: 'IMPLEMENTATION',
    ...
    dependsOn: {
      x21CloseoutArtifactRef: path.relative(repoRoot, signedPath).replaceAll(path.sep, '/'),
      requiredGate: 'GO_IF_X21_CLOSEOUT_ARTIFACT_SIGNED',
      gateSatisfied: true,
    },
    ...
    entryChecks: {
      ...
      x21ContourClosed: allWsAccepted,
    },
