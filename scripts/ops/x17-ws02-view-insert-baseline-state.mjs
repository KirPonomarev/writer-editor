...
const TOKEN_NAME = 'X17_WS02_VIEW_INSERT_BASELINE_OK';
...
const DEFAULT_FILE_EDIT_ACTIONS_PATH = 'docs/OPS/STATUS/X17_VIEW_INSERT_BASELINE_v1.json';
...
const REQUIRED_EDITOR_MARKERS = Object.freeze([
  'dispatchUiCommand(EXTRA_COMMAND_IDS.VIEW_ZOOM_OUT)',
  'dispatchUiCommand(EXTRA_COMMAND_IDS.VIEW_ZOOM_IN)',
  'dispatchUiCommand(EXTRA_COMMAND_IDS.VIEW_TOGGLE_WRAP)',
  'dispatchUiCommand(EXTRA_COMMAND_IDS.INSERT_MARKDOWN_PROMPT)',
  'dispatchUiCommand(EXTRA_COMMAND_IDS.INSERT_FLOW_OPEN)',
  'dispatchUiCommand(EXTRA_COMMAND_IDS.INSERT_ADD_CARD)',
]);
...
function evaluateX17Ws02ViewInsertBaselineState(input = {}) {
  ...
  negative02Binding.delete('cmd.project.insert.addCard');
  ...
  const viewInsertBaselineEnabledWithoutCoreLeak = baseline.ok
    && determinism.ok
  ...
  const dod = {
    NEXT_TZ_DOD_01: viewInsertBaselineEnabledWithoutCoreLeak,
  ...
  const state = {
    ...
    objective: 'VIEW_INSERT_BASELINE_ENABLED_WITH_COMMAND_BUS_AND_CAPABILITY_POLICY',
    ...
    detector: {
      detectorId: 'X17_WS02_VIEW_INSERT_BASELINE_SINGLE_DETECTOR_V1',
  ...
  if (!state.ok) {
    state.failReason = !canonLock.ok
      ...
      : !stageActivationGuardCheck
        ...
        : !dod.NEXT_TZ_DOD_01
          ? 'VIEW_INSERT_BASELINE_NOT_READY'
          : !dod.NEXT_TZ_DOD_02
            ...
            : !dod.NEXT_TZ_DOD_03
              ...
              : !dod.NEXT_TZ_DOD_06
                ...
                : 'X17_WS02_VIEW_INSERT_BASELINE_FAIL';
...
function main() {
  ...
  const state = evaluateX17Ws02ViewInsertBaselineState({
...
export {
  evaluateX17Ws02ViewInsertBaselineState,
  TOKEN_NAME,
};
