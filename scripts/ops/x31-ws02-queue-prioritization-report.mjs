...
import { evaluateX31Ws02QueuePrioritizationState } from './x31-ws02-queue-prioritization-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X31_CONTOUR/TICKET_02';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X31_WS02_QUEUE_PRIORITIZATION_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X31_WS02_QUEUE_PRIORITIZATION_001';
...
function main() {
  ...
  const run1 = evaluateX31Ws02QueuePrioritizationState({ repoRoot });
  const run2 = evaluateX31Ws02QueuePrioritizationState({ repoRoot });
  const run3 = evaluateX31Ws02QueuePrioritizationState({ repoRoot });
