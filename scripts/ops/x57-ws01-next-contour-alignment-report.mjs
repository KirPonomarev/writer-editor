...
import { evaluateX57Ws01NextContourAlignmentState } from './x57-ws01-next-contour-alignment-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X57_CONTOUR/TICKET_01';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X57_WS01_NEXT_CONTOUR_ALIGNMENT_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X57_WS01_NEXT_CONTOUR_ALIGNMENT_001';
...
function main() {
  ...
  const run1 = evaluateX57Ws01NextContourAlignmentState({ repoRoot });
  const run2 = evaluateX57Ws01NextContourAlignmentState({ repoRoot });
  const run3 = evaluateX57Ws01NextContourAlignmentState({ repoRoot });
