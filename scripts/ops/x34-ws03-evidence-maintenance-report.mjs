...
import { evaluateX34Ws03EvidenceMaintenanceState } from './x34-ws03-evidence-maintenance-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X34_CONTOUR/TICKET_03';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X34_WS03_EVIDENCE_MAINTENANCE_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X34_WS03_EVIDENCE_MAINTENANCE_001';
...
function main() {
  ...
  const run1 = evaluateX34Ws03EvidenceMaintenanceState({ repoRoot });
  const run2 = evaluateX34Ws03EvidenceMaintenanceState({ repoRoot });
  const run3 = evaluateX34Ws03EvidenceMaintenanceState({ repoRoot });
