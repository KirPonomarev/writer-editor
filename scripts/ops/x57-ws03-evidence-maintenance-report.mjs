...
import { evaluateX57Ws03EvidenceMaintenanceState } from './x57-ws03-evidence-maintenance-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X57_CONTOUR/TICKET_03';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X57_WS03_EVIDENCE_MAINTENANCE_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X57_WS03_EVIDENCE_MAINTENANCE_001';
...
function main() {
  ...
  const run1 = evaluateX57Ws03EvidenceMaintenanceState({ repoRoot });
  const run2 = evaluateX57Ws03EvidenceMaintenanceState({ repoRoot });
  const run3 = evaluateX57Ws03EvidenceMaintenanceState({ repoRoot });
