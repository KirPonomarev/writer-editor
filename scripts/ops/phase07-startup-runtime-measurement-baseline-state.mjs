...
function evaluatePhase07StartupRuntimeMeasurementBaselineState(input = {}) {
  ...
  try {
    ...
    const checkStatusById = {
      ...
      SCENE_SWITCH_MEASUREMENT_NOT_BOUND: asCheck(sceneSwitchMeasurementOpen ? 'OPEN_GAP' : 'OPEN_GAP', sceneSwitchMeasurementOpen, sceneSwitchMeasurementOpen ? 'SCENE_SWITCH_MEASUREMENT_NOT_BOUND' : 'SCENE_SWITCH_MEASUREMENT_BOUND_UNEXPECTED'),
