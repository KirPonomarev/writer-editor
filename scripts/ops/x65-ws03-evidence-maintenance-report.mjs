...
import { evaluateX65Ws03EvidenceMaintenanceState } from './x65-ws03-evidence-maintenance-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X65_CONTOUR/TICKET_03';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X65_WS03_EVIDENCE_MAINTENANCE_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X65_WS03_EVIDENCE_MAINTENANCE_001';
...
function main() {
  ...
  const run1 = evaluateX65Ws03EvidenceMaintenanceState({ repoRoot });
  const run2 = evaluateX65Ws03EvidenceMaintenanceState({ repoRoot });
  const run3 = evaluateX65Ws03EvidenceMaintenanceState({ repoRoot });
