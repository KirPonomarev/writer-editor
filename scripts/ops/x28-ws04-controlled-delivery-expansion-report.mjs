...
import { evaluateX28Ws04ControlledDeliveryExpansionState } from './x28-ws04-controlled-delivery-expansion-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X28_CONTOUR/TICKET_04';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X28_WS04_CONTROLLED_DELIVERY_EXPANSION_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X28_WS04_CONTROLLED_DELIVERY_EXPANSION_001';
...
function main() {
  ...
  const run1 = evaluateX28Ws04ControlledDeliveryExpansionState({ repoRoot });
  const run2 = evaluateX28Ws04ControlledDeliveryExpansionState({ repoRoot });
  const run3 = evaluateX28Ws04ControlledDeliveryExpansionState({ repoRoot });
