...
const DEFAULT_FREEZE_PATH = 'docs/OPS/EVIDENCE/X19_CONTOUR/x19-contour-freeze-packet-v1.json';
const DEFAULT_CLOSE_SUMMARY_PATH = 'docs/OPS/STATUS/X19_CONTOUR_CLOSE_SUMMARY_V1.json';
const DEFAULT_SIGNED_PATH = 'docs/OPS/STATUS/X19_CONTOUR_CLOSEOUT_SIGNED_V1.json';
const DEFAULT_NEXT_RECORD_PATH = 'docs/OPS/STATUS/NEXT_CONTOUR_OPENING_RECORD_V6.json';
...
const WS_MAP = [
  {
    id: 'WS01',
    ticketId: 'X19_WS01',
    statusRef: 'docs/OPS/STATUS/X19_WS01_FIRST_RUN_AND_EMPTY_STATE_FLOW_v1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X19_CONTOUR/TICKET_01/summary.json',
  },
  {
    id: 'WS02',
    ticketId: 'X19_WS02',
    statusRef: 'docs/OPS/STATUS/X19_WS02_RECENT_PROJECTS_AND_QUICK_RESUME_v1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X19_CONTOUR/TICKET_02/summary.json',
  },
  {
    id: 'WS03',
    ticketId: 'X19_WS03',
    statusRef: 'docs/OPS/STATUS/X19_WS03_ERROR_HANDLING_AND_RECOVERY_HINTS_v1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X19_CONTOUR/TICKET_03/summary.json',
  },
];
...
function parseArgs(argv = process.argv.slice(2)) {
  const out = {
    ...
    runId: 'TZ_X19_WS04_CONTOUR_CLOSE_PREP_001',
  };
...
function main() {
  ...
  const freezePacket = {
    artifactId: 'X19_CONTOUR_EVIDENCE_FREEZE_PACKET_V1',
    schemaVersion: 1,
    generatedAtUtc,
    owner: 'KIRILL_PLUS_CODEX',
    gate: {
      name: 'GO_IF_X19_WS01_WS02_WS03_ALL_ACCEPTED',
    ...
    requiredOutputs: [
      'X19_CONTOUR_FREEZE_PACKET_JSON',
      'X19_CONTOUR_CLOSE_SUMMARY_JSON',
      'X19_CONTOUR_CLOSEOUT_SIGNED_JSON',
  ...
  const signedDoc = {
    artifactId: 'X19_CONTOUR_CLOSEOUT_SIGNED_V1',
    schemaVersion: 1,
    taskId: args.runId,
    status: 'SIGNED',
    ...
    gate: {
      name: 'GO_IF_X19_CLOSEOUT_ARTIFACT_SIGNED',
      isOpen: true,
  ...
  const closeSummary = {
    artifactId: 'X19_CONTOUR_CLOSE_SUMMARY_V1',
    schemaVersion: 1,
    taskId: args.runId,
    ...
    closeout: {
      action01_freezeX19EvidencePacket: 'DONE',
      action02_recordX19ContourCloseSummary: 'DONE',
      action03_openNextContourRecord: 'DONE',
    },
    nextTicket: {
      tzId: 'TZ_X20_CONTOUR_OPENING_001',
      priority: 'P1',
      objective: 'OPEN_NEXT_CONTOUR_WITH_CANON_LOCK_AND_NON_EXPANDING_BLOCKING_SURFACE',
      gate: 'GO_IF_X19_CLOSEOUT_ARTIFACT_SIGNED',
    },
  };
  ...
  const nextRecord = {
    ticketId: 'TZ_X20_CONTOUR_OPENING_001',
    schemaVersion: 1,
    status: 'READY',
    priority: 'P1',
    mode: 'IMPLEMENTATION',
    ...
    dependsOn: {
      x19CloseoutArtifactRef: path.relative(repoRoot, signedPath).replaceAll(path.sep, '/'),
      requiredGate: 'GO_IF_X19_CLOSEOUT_ARTIFACT_SIGNED',
      gateSatisfied: true,
    },
    ...
    entryChecks: {
      ...
      x19ContourClosed: allWsAccepted,
    },
