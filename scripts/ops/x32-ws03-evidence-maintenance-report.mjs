...
import { evaluateX32Ws03EvidenceMaintenanceState } from './x32-ws03-evidence-maintenance-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X32_CONTOUR/TICKET_03';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X32_WS03_EVIDENCE_MAINTENANCE_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X32_WS03_EVIDENCE_MAINTENANCE_001';
...
function main() {
  ...
  const run1 = evaluateX32Ws03EvidenceMaintenanceState({ repoRoot });
  const run2 = evaluateX32Ws03EvidenceMaintenanceState({ repoRoot });
  const run3 = evaluateX32Ws03EvidenceMaintenanceState({ repoRoot });
