...
import { evaluateX56Ws01NextContourAlignmentState } from './x56-ws01-next-contour-alignment-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X56_CONTOUR/TICKET_01';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X56_WS01_NEXT_CONTOUR_ALIGNMENT_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X56_WS01_NEXT_CONTOUR_ALIGNMENT_001';
...
function main() {
  ...
  const run1 = evaluateX56Ws01NextContourAlignmentState({ repoRoot });
  const run2 = evaluateX56Ws01NextContourAlignmentState({ repoRoot });
  const run3 = evaluateX56Ws01NextContourAlignmentState({ repoRoot });
