...
import { evaluateX37Ws02QueuePrioritizationState } from './x37-ws02-queue-prioritization-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X37_CONTOUR/TICKET_02';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X37_WS02_QUEUE_PRIORITIZATION_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X37_WS02_QUEUE_PRIORITIZATION_001';
...
function main() {
  ...
  const run1 = evaluateX37Ws02QueuePrioritizationState({ repoRoot });
  const run2 = evaluateX37Ws02QueuePrioritizationState({ repoRoot });
  const run3 = evaluateX37Ws02QueuePrioritizationState({ repoRoot });
