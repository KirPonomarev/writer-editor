...
const DEFAULT_FREEZE_PATH = 'docs/OPS/EVIDENCE/X17_CONTOUR/x17-contour-freeze-packet-v1.json';
const DEFAULT_CLOSE_SUMMARY_PATH = 'docs/OPS/STATUS/X17_CONTOUR_CLOSE_SUMMARY_V1.json';
const DEFAULT_SIGNED_PATH = 'docs/OPS/STATUS/X17_CONTOUR_CLOSEOUT_SIGNED_V1.json';
const DEFAULT_NEXT_RECORD_PATH = 'docs/OPS/STATUS/NEXT_CONTOUR_OPENING_RECORD_V4.json';
...
const WS_MAP = [
  {
    id: 'WS01',
    ticketId: 'X17_WS01',
    statusRef: 'docs/OPS/STATUS/X17_WS01_FILE_EDIT_CORE_ACTIONS_v1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X17_CONTOUR/TICKET_01/summary.json',
  },
  {
    id: 'WS02',
    ticketId: 'X17_WS02',
    statusRef: 'docs/OPS/STATUS/X17_WS02_VIEW_INSERT_BASELINE_v1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X17_CONTOUR/TICKET_02/summary.json',
  },
  {
    id: 'WS03',
    ticketId: 'X17_WS03',
    statusRef: 'docs/OPS/STATUS/X17_WS03_FORMAT_PLAN_REVIEW_ACTIONS_v1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X17_CONTOUR/TICKET_03/summary.json',
  },
];
...
function parseArgs(argv = process.argv.slice(2)) {
  const out = {
    ...
    runId: 'TZ_X17_CONTOUR_CLOSEOUT_001',
  };
...
function main() {
  ...
  const freezePacket = {
    artifactId: 'X17_CONTOUR_EVIDENCE_FREEZE_PACKET_V1',
    schemaVersion: 1,
    generatedAtUtc,
    owner: 'KIRILL_PLUS_CODEX',
    gate: {
      name: 'GO_IF_X17_WS01_WS02_WS03_ALL_ACCEPTED',
    ...
    requiredOutputs: [
      'X17_CONTOUR_FREEZE_PACKET_JSON',
      'X17_CONTOUR_CLOSE_SUMMARY_JSON',
      'X17_CONTOUR_CLOSEOUT_SIGNED_JSON',
  ...
  const signedDoc = {
    artifactId: 'X17_CONTOUR_CLOSEOUT_SIGNED_V1',
    schemaVersion: 1,
    taskId: args.runId,
    status: 'SIGNED',
    ...
    gate: {
      name: 'GO_IF_X17_CLOSEOUT_ARTIFACT_SIGNED',
      isOpen: true,
  ...
  const closeSummary = {
    artifactId: 'X17_CONTOUR_CLOSE_SUMMARY_V1',
    schemaVersion: 1,
    taskId: args.runId,
    ...
    closeout: {
      action01_freezeX17EvidencePacket: 'DONE',
      action02_recordX17ContourCloseSummary: 'DONE',
      action03_openNextContourRecord: 'DONE',
    },
    nextTicket: {
      tzId: 'TZ_X18_CONTOUR_OPENING_001',
      priority: 'P1',
      objective: 'OPEN_NEXT_CONTOUR_WITH_CANON_LOCK_AND_NON_EXPANDING_BLOCKING_SURFACE',
      gate: 'GO_IF_X17_CLOSEOUT_ARTIFACT_SIGNED',
    },
  };
  ...
  const nextRecord = {
    ticketId: 'TZ_X18_CONTOUR_OPENING_001',
    schemaVersion: 1,
    status: 'READY',
    priority: 'P1',
    mode: 'IMPLEMENTATION',
    ...
    dependsOn: {
      x17CloseoutArtifactRef: path.relative(repoRoot, signedPath).replaceAll(path.sep, '/'),
      requiredGate: 'GO_IF_X17_CLOSEOUT_ARTIFACT_SIGNED',
      gateSatisfied: true,
    },
    ...
    entryChecks: {
      ...
      x17ContourClosed: allWsAccepted,
    },
