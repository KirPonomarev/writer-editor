...
export const DATA_POLICY_SHA256='a038a345afe566653dfe390f495d3dac2b313890dfcb7e98634a56e8a4e2eacf';
...
function validateLabRevision(labRoot,revision,policy) {
  ...
  for(const b of policy.labCodeBindings)demand(hash(git(['show',revision+':'+b.path]))===b.sha256,'DATA_LAB_CODE_PIN');
}
