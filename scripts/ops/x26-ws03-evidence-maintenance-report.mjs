...
import { evaluateX26Ws03EvidenceMaintenanceState } from './x26-ws03-evidence-maintenance-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X26_CONTOUR/TICKET_03';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X26_WS03_EVIDENCE_MAINTENANCE_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X26_WS03_EVIDENCE_MAINTENANCE_001';
...
function main() {
  ...
  const run1 = evaluateX26Ws03EvidenceMaintenanceState({ repoRoot });
  const run2 = evaluateX26Ws03EvidenceMaintenanceState({ repoRoot });
  const run3 = evaluateX26Ws03EvidenceMaintenanceState({ repoRoot });
  ...
  const summary = {
    ...
    objective: 'MAINTAIN_EVIDENCE_CHAIN_INTEGRITY_FOR_CONTROLLED_DELIVERY_EXPANSION',
