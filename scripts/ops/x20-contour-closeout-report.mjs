...
const DEFAULT_FREEZE_PATH = 'docs/OPS/EVIDENCE/X20_CONTOUR/x20-contour-freeze-packet-v1.json';
const DEFAULT_CLOSE_SUMMARY_PATH = 'docs/OPS/STATUS/X20_CONTOUR_CLOSE_SUMMARY_V1.json';
const DEFAULT_SIGNED_PATH = 'docs/OPS/STATUS/X20_CONTOUR_CLOSEOUT_SIGNED_V1.json';
const DEFAULT_NEXT_RECORD_PATH = 'docs/OPS/STATUS/NEXT_CONTOUR_OPENING_RECORD_V7.json';
...
const WS_MAP = [
  {
    id: 'WS01',
    ticketId: 'X20_WS01',
    statusRef: 'docs/OPS/STATUS/X20_WS01_RELEASE_CHECKLIST_AND_ONBOARDING_POLISH_v1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X20_CONTOUR/TICKET_01/summary.json',
  },
  {
    id: 'WS02',
    ticketId: 'X20_WS02',
    statusRef: 'docs/OPS/STATUS/X20_WS02_USABILITY_REGRESSION_GUARD_PACK_v1.json',
    summaryRef: 'docs/OPS/EVIDENCE/X20_CONTOUR/TICKET_02/summary.json',
  },
];
...
function parseArgs(argv = process.argv.slice(2)) {
  const out = {
    ...
    runId: 'TZ_X20_WS03_RELEASE_WRAP_CLOSE_PREP_001',
  };
...
function main() {
  ...
  const freezePacket = {
    artifactId: 'X20_CONTOUR_EVIDENCE_FREEZE_PACKET_V1',
    schemaVersion: 1,
    generatedAtUtc,
    owner: 'KIRILL_PLUS_CODEX',
    gate: {
      name: 'GO_IF_X20_WS01_AND_X20_WS02_ACCEPTED',
    ...
    requiredOutputs: [
      'X20_CONTOUR_FREEZE_PACKET_JSON',
      'X20_CONTOUR_CLOSE_SUMMARY_JSON',
      'X20_CONTOUR_CLOSEOUT_SIGNED_JSON',
  ...
  const signedDoc = {
    artifactId: 'X20_CONTOUR_CLOSEOUT_SIGNED_V1',
    schemaVersion: 1,
    taskId: args.runId,
    status: 'SIGNED',
    ...
    gate: {
      name: 'GO_IF_X20_CLOSEOUT_ARTIFACT_SIGNED',
      isOpen: true,
  ...
  const closeSummary = {
    artifactId: 'X20_CONTOUR_CLOSE_SUMMARY_V1',
    schemaVersion: 1,
    taskId: args.runId,
    ...
    closeout: {
      action01_freezeX20EvidencePacket: 'DONE',
      action02_recordX20ContourCloseSummary: 'DONE',
      action03_openNextContourRecord: 'DONE',
    },
    nextTicket: {
      tzId: 'TZ_X21_CONTOUR_OPENING_001',
      priority: 'P1',
      objective: 'OPEN_NEXT_CONTOUR_WITH_CANON_LOCK_AND_NON_EXPANDING_BLOCKING_SURFACE',
      gate: 'GO_IF_X20_CLOSEOUT_ARTIFACT_SIGNED',
    },
  };
  ...
  const nextRecord = {
    ticketId: 'TZ_X21_CONTOUR_OPENING_001',
    schemaVersion: 1,
    status: 'READY',
    priority: 'P1',
    mode: 'IMPLEMENTATION',
    ...
    dependsOn: {
      x20CloseoutArtifactRef: path.relative(repoRoot, signedPath).replaceAll(path.sep, '/'),
      requiredGate: 'GO_IF_X20_CLOSEOUT_ARTIFACT_SIGNED',
      gateSatisfied: true,
    },
    ...
    entryChecks: {
      ...
      x20ContourClosed: allWsAccepted,
    },
