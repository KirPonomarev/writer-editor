...
import { evaluateX66Ws01NextContourAlignmentState } from './x66-ws01-next-contour-alignment-state.mjs';

const DEFAULT_OUTPUT_DIR = 'docs/OPS/EVIDENCE/X66_CONTOUR/TICKET_01';
const DEFAULT_STATUS_PATH = 'docs/OPS/STATUS/X66_WS01_NEXT_CONTOUR_ALIGNMENT_STATUS_V1.json';
const DEFAULT_RUN_ID = 'TZ_X66_WS01_NEXT_CONTOUR_ALIGNMENT_001';
...
function main() {
  ...
  const run1 = evaluateX66Ws01NextContourAlignmentState({ repoRoot });
  const run2 = evaluateX66Ws01NextContourAlignmentState({ repoRoot });
  const run3 = evaluateX66Ws01NextContourAlignmentState({ repoRoot });
